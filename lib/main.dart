...
    _alignRight(socket);
    // 2. ÜRÜN TOPLAMINDA € KALDIRILDI
    _writeCp1252(socket, _moneyNoEuro(l.total) + '\n');
    _alignLeft(socket);
    _writeCp1252(socket, '\n');
  }

  // 5. TOPLAM BLOKU TAMAMEN DEĞİŞTİRİLDİ
  _writeCp1252(socket, '---\n');
  _alignRight(socket);
  _writeCp1252(socket, _rightLine('Sous-total', _moneyNoEuro(o.total)) + '\n');
  _writeCp1252(socket, _rightLine('Total',      _moneyEuroLeft(o.total)) + '\n');
  _alignLeft(socket);
